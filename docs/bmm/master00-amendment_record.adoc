...
|openEHR SEC
|[[latest_issue_date]]19 Jul 2019

|
|Add meta-model for functional entities. Re-structure packages. Modify `BMM_REFERENCEABLE._signature_` to new meta-type, `BMM_SIGNATURE`.
|T Beale 
|18 Jul 2019
