...
The central elements of the BMM model are meta-classes representing _classes_ and _types_, collectively known as _entities_. These are shown in the following UML diagram.
