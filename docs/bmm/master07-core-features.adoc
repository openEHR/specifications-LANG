...
Constant class features (meta-type `BMM_CONSTANT`) correspond to classic constants in most computer languages, and are defined by literal value.
...
include::{uml_export_dir}/classes/bmm_static.adoc[]
include::{uml_export_dir}/classes/bmm_constant.adoc[]
include::{uml_export_dir}/classes/bmm_singleton.adoc[]
...
include::{uml_export_dir}/classes/bmm_routine_definition.adoc[]
include::{uml_export_dir}/classes/bmm_local_routine.adoc[]
include::{uml_export_dir}/classes/bmm_external_routine.adoc[]
