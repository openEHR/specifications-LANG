...
h|*1..1*
|*generic_parameters*: `link:/releases/BASE/{lang_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^],<<_bmm_parameter_type_class,BMM_PARAMETER_TYPE>>>`
