...
h|*0..1*
|*classes*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_bmm_class_class,BMM_CLASS>>>`
...
h|*0..1*
|*root_classes* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_bmm_class_class,BMM_CLASS>>>`
...
h|*1..1*
|*path* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]`
