...
h|*1..1*
|*root_type*: `link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]`
a|Root type of this generic type, e.g. `Interval` in `Interval<Integer>`.

h|*1..1*
|*generic_parameter_defs*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_p_bmm_type_class,P_BMM_TYPE>>>`
...
h|*0..1*
|*generic_parameters*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]>`
...
h|*0..1*
|*generic_parameter_refs* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_p_bmm_type_class,P_BMM_TYPE>>>`
