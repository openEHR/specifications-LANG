...
h|*0..1*
|*feature_groups*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_bmm_feature_group_class,BMM_FEATURE_GROUP>>>`
...
h|*0..1*
|*flat_features* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_bmm_class_feature_class,BMM_CLASS_FEATURE>>>`
