...
h|*0..1*
|*precedence_overridden*: `link:/releases/BASE/{lang_release}/foundation_types.html#_boolean_class[Boolean^]`
...
h|*0..1*
|*symbol*: `link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]`
