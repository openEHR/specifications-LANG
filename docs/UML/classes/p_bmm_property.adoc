...
h|*0..1*
|*is_mandatory*: `link:/releases/BASE/{lang_release}/foundation_types.html#_boolean_class[Boolean^]`
a|True if this property is mandatory in its class. Persisted attribute.

h|*0..1*
|*is_computed*: `link:/releases/BASE/{lang_release}/foundation_types.html#_boolean_class[Boolean^]`
