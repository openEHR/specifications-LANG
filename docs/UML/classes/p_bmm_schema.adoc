...
h|*0..1 +
(redefined)*
|*primitive_types*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_p_bmm_class_class,P_BMM_CLASS>>>`
a|Primitive type definitions. Persisted attribute.

h|*0..1 +
(redefined)*
|*class_definitions*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_p_bmm_class_class,P_BMM_CLASS>>>`
a|Class definitions. Persisted attribute.

h|*0..1 +
(redefined)*
|*includes*: `link:/releases/BASE/{lang_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^],<<_bmm_include_spec_class,BMM_INCLUDE_SPEC>>>`
