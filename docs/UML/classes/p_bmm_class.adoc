...
h|*0..1*
|*ancestors*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]>`
a|List of immediate inheritance parents. If there are generic ancestors, use `_ancestor_defs_` instead. Persisted attribute.

h|*0..1*
|*properties*: `link:/releases/BASE/{lang_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^],<<_p_bmm_property_class,P_BMM_PROPERTY>>>`
...
h|*0..1*
|*generic_parameter_defs*: `link:/releases/BASE/{lang_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^],<<_p_bmm_generic_parameter_class,P_BMM_GENERIC_PARAMETER>>>`
...
h|*1..1*
|*uid*: `link:/releases/BASE/{lang_release}/foundation_types.html#_integer_class[Integer^]`
...
h|*0..1*
|*ancestor_defs*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_p_bmm_generic_type_class,P_BMM_GENERIC_TYPE>>>`
...
h|*1..1*
|*is_generic* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_boolean_class[Boolean^]` +
 +
