...
h|*0..1*
|*cardinality*: `link:/releases/BASE/{lang_release}/foundation_types.html#_interval_class[Interval^]<link:/releases/BASE/{lang_release}/foundation_types.html#_integer_class[Integer^]>`
