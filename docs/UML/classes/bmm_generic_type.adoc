...
h|*1..1*
|*generic_parameters*: `link:/releases/BASE/{lang_release}/foundation_types.html#_list_class[List^]<<<_bmm_unitary_type_class,BMM_UNITARY_TYPE>>>`
...
h|*1..1 +
(redefined)*
|*type_signature* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]`
...
h|*1..1*
|*is_partially_closed* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_boolean_class[Boolean^]`
...
h|*1..1*
|*is_open* (): `link:/releases/BASE/{lang_release}/foundation_types.html#_boolean_class[Boolean^]`
