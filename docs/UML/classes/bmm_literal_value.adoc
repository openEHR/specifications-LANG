...
h|*1..1*
|*value_literal*: `link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]`
a|A serial representation of the value.

h|*0..1*
|*value*: `link:/releases/BASE/{lang_release}/foundation_types.html#_any_class[Any^]`
a|A native representation of the value, possibly derived by deserialising `_value_literal_`.

h|*0..1*
|*syntax*: `link:/releases/BASE/{lang_release}/foundation_types.html#_string_class[String^]`
