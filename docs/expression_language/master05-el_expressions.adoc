...
The syntax for a condition chain (the if/then equivalent) takes a standard form and a compact form. The standard form is as follows, and is used for multi-branch decision structures.
