...
|[[latest_issue]]1.5.2
|{openehr_jira}/SPECLANG-7[SPECLANG-7]: Move IDON spec to LANG component.
|openEHR SEC
|[[latest_issue_date]]11 Nov 2018

|
|{openehr_jira}/SPECLANG-3[SPECLANG-3]: Add grammar support for plus-or-minus ranges; +
 {openehr_jira}/SPECLANG-4[SPECLANG-4]: Update grammar to support documented ODIN keys; + 
 {openehr_jira}/SPECLANG-5[SPECLANG-5]: Update grammar to support documented openEHR ISO 8601 variant using '??';
...
|
|{openehr_jira}/SPECLANG-6[SPECLANG-6]: Correct minor comment errors in section 7 to do with intervals.
|C Nanjo
|08 Apr 2016
