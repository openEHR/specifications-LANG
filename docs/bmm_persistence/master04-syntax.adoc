...
The use of the `value_constraint` attribute forces the use of the `type_ref` structural form of the type definition, rather than the simple `String` form above.
