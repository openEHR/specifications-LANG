...
[.text-center]
.Feature taxonomy
image::diagrams/feature_taxonomy.svg[id=feature_taxonomy, align="center"]
...
[.text-center]
.Typed taxonomy
image::diagrams/typed_taxonomy.svg[id=typed_taxonomy, align="center"]
...
image::ROOT:uml/LANG-bmm.core.feature.svg[id=core_feature, align="center"]
...
[.text-center]
.Signature taxonomy
image::diagrams/signature_taxonomy.svg[id=signature_taxonomy, align="center", width="40%"]
...
image::awb_class_properties.png[id=awb_class_properties, align="center", width="50%"]
...
Any routine may have pre- and/or post-conditions defined for it, represented in BMM by `BMM_ASSERTIONs` populating the `_pre_conditions_` and `_post_conditions_` attributes of `BMM_ROUINE`. An Assertion is a xref:{class_bmm_assertion}[tagged Boolean Expression].
...
image::ROOT:uml/LANG-bmm.core.class-creators.svg[id=core_class_creators, align="center"]
...
[.text-center]
.Routine body
image::ROOT:uml/LANG-bmm.core.feature-routine.svg[id=core_feature_routine, align="center"]
...
include::ROOT:partial$classes/bmm_typed.adoc[]

include::ROOT:partial$classes/bmm_feature_group.adoc[]
include::ROOT:partial$classes/bmm_visibility.adoc[]

include::ROOT:partial$classes/bmm_class_entity.adoc[]
include::ROOT:partial$classes/bmm_class_feature.adoc[]
include::ROOT:partial$classes/bmm_typed_feature.adoc[]
include::ROOT:partial$classes/bmm_instantiable.adoc[]

include::ROOT:partial$classes/bmm_constant.adoc[]

include::ROOT:partial$classes/bmm_property.adoc[]
include::ROOT:partial$classes/bmm_unitary_property.adoc[]
include::ROOT:partial$classes/bmm_container_property.adoc[]
include::ROOT:partial$classes/bmm_indexed_container_property.adoc[]

include::ROOT:partial$classes/bmm_routine.adoc[]
include::ROOT:partial$classes/bmm_function.adoc[]
include::ROOT:partial$classes/bmm_operator.adoc[]
include::ROOT:partial$classes/bmm_operator_position.adoc[]
include::ROOT:partial$classes/bmm_procedure.adoc[]

include::ROOT:partial$classes/bmm_variable.adoc[]
include::ROOT:partial$classes/bmm_local.adoc[]
include::ROOT:partial$classes/bmm_parameter.adoc[]
include::ROOT:partial$classes/bmm_result.adoc[]
include::ROOT:partial$classes/bmm_parameter_direction.adoc[]

include::ROOT:partial$classes/bmm_routine_body.adoc[]
include::ROOT:partial$classes/bmm_routine_external.adoc[]
