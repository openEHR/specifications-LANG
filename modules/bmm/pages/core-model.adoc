...
image::ROOT:uml/LANG-bmm.core.model.svg[id=core_model, align="center"]
...
[.text-center]
.Default `Any` class
image::ROOT:uml/LANG-bmm-any_class.svg[id=bmm_any_class, align="center"]
...
include::ROOT:partial$classes/bmm_module.adoc[]
