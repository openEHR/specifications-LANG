...
image::ROOT:uml/LANG-bmm.expression-functional.svg[id=bmm_expression_functional, align="center"]
...
image::ROOT:uml/LANG-bmm-nested_call.svg[id=bmm_nested_call, align="center"]
