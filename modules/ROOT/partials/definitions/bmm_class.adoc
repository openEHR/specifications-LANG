...
h|*Inherit*
2+|`xref:{class_bmm_module}[BMM_MODULE]`
...
h|*0..1*
|*properties*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_property}[BMM_PROPERTY]>`
...
h|*0..1*
|*immediate_descendants*: `link:/classes/List[List] <xref:{class_bmm_class}[BMM_CLASS]>`
...
h|*0..1*
|*constants*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_constant}[BMM_CONSTANT]>`
a|List of constants defined in this class.

h|*0..1*
|*functions*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_function}[BMM_FUNCTION]>`
a|List of functions defined in this class.

h|*0..1*
|*procedures*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_procedure}[BMM_PROCEDURE]>`
...
h|*0..1*
|*invariants*: `link:/classes/List[List] <xref:{class_bmm_assertion}[BMM_ASSERTION]>`
a|
...
h|*0..1*
|*feature_groups*: `link:/classes/List[List] <xref:{class_bmm_feature_group}[BMM_FEATURE_GROUP]>`
...
h|*1..1 +
(abstract)*
|*type* (): `xref:{class_bmm_model_type}[BMM_MODEL_TYPE]`
...
h|*0..1*
|*features* (): `link:/classes/List[List] <xref:{class_bmm_class_feature}[BMM_CLASS_FEATURE]>`
a|List of all feature definitions introduced in this class.

h|*0..1*
|*flat_features* (): `link:/classes/List[List] <xref:{class_bmm_class_feature}[BMM_CLASS_FEATURE]>`
a|Consolidated list of all feature definitions from this class and all inheritance ancestors.

h|*0..1*
|*flat_properties* (): `link:/classes/List[List] <xref:{class_bmm_property}[BMM_PROPERTY]>`
