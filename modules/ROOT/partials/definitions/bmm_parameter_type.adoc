...
h|*0..1*
|*type_constraint*: `xref:{class_bmm_effective_type}[BMM_EFFECTIVE_TYPE]`
...
h|*1..1*
|*flattened_conforms_to_type* (): `xref:{class_bmm_effective_type}[BMM_EFFECTIVE_TYPE]`
...
h|*1..1 +
(effected)*
|*effective_type* (): `xref:{class_bmm_effective_type}[BMM_EFFECTIVE_TYPE]`
