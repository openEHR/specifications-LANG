...
h|*0..1*
|*class_definitions*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_class}[BMM_CLASS]>`
a|All classes in this model, keyed by type name.

h|*0..1*
|*used_models*: `link:/classes/List[List] <xref:{class_bmm_model}[BMM_MODEL]>`
...
h|*1..1*
|*boolean_type_definition* (): `xref:{class_bmm_simple_type}[BMM_SIMPLE_TYPE]`
