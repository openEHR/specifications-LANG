...
h|*0..1*
|*properties*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_p_bmm_property}[P_BMM_PROPERTY]>`
...
h|*0..1*
|*generic_parameter_defs*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_p_bmm_generic_parameter}[P_BMM_GENERIC_PARAMETER]>`
...
h|*0..1*
|*ancestor_defs*: `link:/classes/List[List] <xref:{class_p_bmm_generic_type}[P_BMM_GENERIC_TYPE]>`
