...
h|*0..1*
|*classes*: `link:/classes/List[List] <xref:LANG:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
...
h|*0..1*
|*root_classes* (): `link:/classes/List[List] <xref:LANG:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
