...
h|*1..1*
|*generic_parameter_defs*: `link:/classes/List[List] <xref:{class_p_bmm_type}[P_BMM_TYPE]>`
...
h|*0..1*
|*generic_parameter_refs* (): `link:/classes/List[List] <xref:{class_p_bmm_type}[P_BMM_TYPE]>`
