...
2+|Inherits: xref:{class_bmm_declaration}[BMM_DECLARATION], xref:{class_bmm_module}[BMM_MODULE], xref:{class_bmm_class}[BMM_CLASS], xref:{class_bmm_simple_class}[BMM_SIMPLE_CLASS], xref:{class_bmm_enumeration}[BMM_ENUMERATION]
...
|*scope*: `xref:{class_bmm_model}[BMM_MODEL]` [1..1]
a|Model within which module is defined. +
_Inherited from xref:{class_bmm_module}[BMM_MODULE]_
...
|*properties*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_property}[BMM_PROPERTY]>` [0..1]
...
|*immediate_descendants*: `link:/classes/List[List] <xref:{class_bmm_class}[BMM_CLASS]>` [0..1]
...
|*constants*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_constant}[BMM_CONSTANT]>` [0..1]
a|List of constants defined in this class. +
_Inherited from xref:{class_bmm_class}[BMM_CLASS]_

|*functions*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_function}[BMM_FUNCTION]>` [0..1]
a|List of functions defined in this class. +
_Inherited from xref:{class_bmm_class}[BMM_CLASS]_

|*procedures*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_procedure}[BMM_PROCEDURE]>` [0..1]
...
|*invariants*: `link:/classes/List[List] <xref:{class_bmm_assertion}[BMM_ASSERTION]>` [0..1]
a| +
_Inherited from xref:{class_bmm_class}[BMM_CLASS]_
...
|*feature_groups*: `link:/classes/List[List] <xref:{class_bmm_feature_group}[BMM_FEATURE_GROUP]>` [0..1]
...
|*item_values*: `link:/classes/List[List] <xref:{class_bmm_integer_value}[BMM_INTEGER_VALUE]>` [0..1]
...
|*features* (): `link:/classes/List[List] <xref:{class_bmm_class_feature}[BMM_CLASS_FEATURE]>` [0..1]
a|List of all feature definitions introduced in this class. +
_Inherited from xref:{class_bmm_class}[BMM_CLASS]_

|*flat_features* (): `link:/classes/List[List] <xref:{class_bmm_class_feature}[BMM_CLASS_FEATURE]>` [0..1]
a|Consolidated list of all feature definitions from this class and all inheritance ancestors. +
_Inherited from xref:{class_bmm_class}[BMM_CLASS]_

|*flat_properties* (): `link:/classes/List[List] <xref:{class_bmm_property}[BMM_PROPERTY]>` [0..1]
