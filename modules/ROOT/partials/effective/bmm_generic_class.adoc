...
2+|Inherits: xref:{class_bmm_declaration}[BMM_DECLARATION], xref:{class_bmm_module}[BMM_MODULE], xref:{class_bmm_class}[BMM_CLASS]
...
|*generic_parameters*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,xref:{class_bmm_parameter_type}[BMM_PARAMETER_TYPE]>` [1..1]
